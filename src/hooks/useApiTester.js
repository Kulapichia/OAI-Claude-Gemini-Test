...
async function getOpenAIModels(apiKey, proxyUrl) {
  try {
    const baseUrl = proxyUrl || 'https://openai.chiangma.com/v1';
...
async function getClaudeModels(apiKey, proxyUrl) {
  ...
  const baseUrl = proxyUrl || 'https://claudet.chiangma.com/v1';
...
async function getGeminiModels(apiKey, proxyUrl) {
  try {
    const baseUrl = proxyUrl || 'https://geminit.chiangma.com/v1beta';
